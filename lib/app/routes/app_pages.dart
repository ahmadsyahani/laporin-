...
import '../modules/all_laporan/bindings/all_laporan_binding.dart';
import '../modules/all_laporan/views/all_laporan_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.ALL_LAPORAN,
      page: () => const AllLaporanView(),
      binding: AllLaporanBinding(),
    ),
  ];
}
